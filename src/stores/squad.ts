...
const initialSquad: Player[] = [
    { id: 1, name: 'Ederson', defaultSlot: 'gk', shortPass: 99, longPass: 1, shooting: 20 },
    { id: 2, name: 'Gvardiol', defaultSlot: 'lb', shortPass: 78, longPass: 75, shooting: 55 },
    { id: 3, name: 'Dias', defaultSlot: 'lcb', shortPass: 82, longPass: 68, shooting: 40 },
    { id: 4, name: 'Stones', defaultSlot: 'rcb', shortPass: 90, longPass: 80, shooting: 50 },
    { id: 5, name: 'Walker', defaultSlot: 'rb', shortPass: 75, longPass: 62, shooting: 45 },
    { id: 6, name: 'Rodri', defaultSlot: 'lcm', shortPass: 93, longPass: 86, shooting: 65 },
    { id: 7, name: 'De Bruyne', defaultSlot: 'cm', shortPass: 92, longPass: 97, shooting: 88 },
    { id: 8, name: 'Bernardo', defaultSlot: 'rcm', shortPass: 90, longPass: 78, shooting: 72 },
    { id: 9, name: 'Foden', defaultSlot: 'lw', shortPass: 86, longPass: 76, shooting: 84 },
    { id: 10, name: 'Haaland', defaultSlot: 'st', shortPass: 70, longPass: 50, shooting: 96 },
    { id: 11, name: 'Doku', defaultSlot: 'rw', shortPass: 72, longPass: 58, shooting: 78 },
]
